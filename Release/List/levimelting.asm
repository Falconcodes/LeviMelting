...
; 0000 0023 
; 0000 0024 
; 0000 0025 //  //Настройка прерывания по таймеру
; 0000 0026 //  TIMSK0=(1<<OCIE0A);
; 0000 0027 
; 0000 0028 //  PORTD.2=1; //первоначальное состояние
; 0000 0029 //  portbuf = PORTD; //вносим состояние порта в буфер
; 0000 002A */
; 0000 002B 
...
; 0000 002F   OCR2A=255;   //общий период
	LDI  R30,LOW(255)
	STS  179,R30
; 0000 0030   OCR2B=100;    //время высокого уровня
	LDI  R30,LOW(100)
	STS  180,R30
; 0000 0031 
